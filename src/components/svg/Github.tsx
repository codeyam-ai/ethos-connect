...
const Github = ({ width = 24, color="#1B1F23" }: { width?: number; color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={width} viewBox="0 0 1024 1024" fill="none"> 
